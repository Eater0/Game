...
class Attack : Agent
{
    ...
    {
        direction = victim.position - transform.position;
    ...
    /*public override void OnEpisodeBegin()
    {
        ...
        victim.localPosition = new Vector3(Random.Range(-40, 40), 1, Random.Range(-40, 40));
        victim.localRotation = Quaternion.Euler(0, Random.Range(-180, 180), 0);
    }
